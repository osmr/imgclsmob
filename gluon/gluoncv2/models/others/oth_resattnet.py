...
def _test():
    ...
    for model in models:
        ...
        assert (model != residualattentionnet56 or weight_count == 31810728)
        assert (model != residualattentionnet92 or weight_count == 52466344)
        assert (model != residualattentionnet128 or weight_count == 65294504)
        assert (model != residualattentionnet164 or weight_count == 78122664)
        assert (model != residualattentionnet200 or weight_count == 90950824)
        assert (model != residualattentionnet236 or weight_count == 103778984)
        assert (model != residualattentionnet452 or weight_count == 182285224)
