...
trained_model_metainfo_list = (
    ('alexnet', 'AlexNet', '1404.5997', 224, 0.875, 'pytorch'),
    ('alexnetb', 'AlexNet-b', '1404.5997', 224, 0.875, 'pytorch'),
    ('zfnet', 'ZFNet', '1311.2901', 224, 0.875, 'pytorch'),
    ('zfnetb', 'ZFNet-b', '1311.2901', 224, 0.875, 'pytorch'),
    ('vgg11', 'VGG-11', '1409.1556', 224, 0.875, 'pytorch'),
    ('vgg13', 'VGG-13', '1409.1556', 224, 0.875, 'pytorch'),
    ('vgg16', 'VGG-16', '1409.1556', 224, 0.875, 'pytorch'),
    ('vgg19', 'VGG-19', '1409.1556', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('bn_vgg11', 'BN-VGG-11', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg13', 'BN-VGG-13', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg16', 'BN-VGG-16', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg19', 'BN-VGG-19', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg11b', 'BN-VGG-11b', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg13b', 'BN-VGG-13b', '1409.1556', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('bn_vgg16b', 'BN-VGG-16b', '1409.1556', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('bn_vgg19b', 'BN-VGG-19b', '1409.1556', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('bninception', 'BN-Inception', '1502.03167', 224, 0.875, 'pytorch'),
    ('resnet10', 'ResNet-10', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet12', 'ResNet-12', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet14', 'ResNet-14', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet16', 'ResNet-16', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet18', 'ResNet-18', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet26', 'ResNet-26', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnetbc26b', 'ResNet-BC-26b', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet34', 'ResNet-34', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnetbc38b', 'ResNet-BC-38b', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet50', 'ResNet-50', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet50b', 'ResNet-50b', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet101', 'ResNet-101', '1512.03385', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('resnet101b', 'ResNet-101b', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet152', 'ResNet-152', '1512.03385', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('resnet152b', 'ResNet-152b', '1512.03385', 224, 0.875, 'pytorch'),
    ('preresnet10', 'PrepResNet-10', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet12', 'PreResNet-12', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet14', 'PreResNet-14', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet16', 'PreResNet-16', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet18', 'PreResNet-18', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet26', 'PreResNet-26', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnetbc26b', 'PreResNet-BC-26b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet34', 'PreResNet-34', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnetbc38b', 'PreResNet-BC-38b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet50', 'PreResNet-50', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet50b', 'PreResNet-50b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet101', 'PreResNet-101', '1603.05027', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('preresnet101b', 'PreResNet-101b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet152', 'PreResNet-152', '1603.05027', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('preresnet152b', 'PreResNet-152b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet200b', 'PreResNet-200b', '1603.05027', 224, 0.875, 'pytorch, from [tornadomeet/ResNet]'),
    ('preresnet269b', 'PreResNet-269b', '1603.05027', 224, 0.875, 'pytorch, from [soeaver/mxnet-model]'),
    ('resnext14_16x4d', 'ResNeXt-14 (16x4d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext14_32x2d', 'ResNeXt-14 (32x2d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext14_32x4d', 'ResNeXt-14 (32x4d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext26_32x2d', 'ResNeXt-26 (32x2d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext26_32x4d', 'ResNeXt-26 (32x4d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext101_32x4d', 'ResNeXt-101 (32x4d)', '1611.05431', 224, 0.875,
     'pytorch, from [Cadene/pretrained...pytorch]'),
    ('resnext101_64x4d', 'ResNeXt-101 (64x4d)', '1611.05431', 224, 0.875,
     'pytorch, from [Cadene/pretrained...pytorch]'),
    ('seresnet10', 'SE-ResNet-10', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet18', 'SE-ResNet-18', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet26', 'SE-ResNet-26', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnetbc26b', 'SE-ResNet-BC-26b', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnetbc38b', 'SE-ResNet-BC-38b', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet50', 'SE-ResNet-50', '1709.01507', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('seresnet50b', 'SE-ResNet-50b', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet101', 'SE-ResNet-101', '1709.01507', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('seresnet152', 'SE-ResNet-152', '1709.01507', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('sepreresnet10', 'SE-PreResNet-10', '1709.01507', 224, 0.875, 'pytorch'),
    ('sepreresnet18', 'SE-PreResNet-18', '1709.01507', 224, 0.875, 'pytorch'),
    ('sepreresnetbc26b', 'SE-PreResNet-BC-26b', '1709.01507', 224, 0.875, 'pytorch'),
    ('sepreresnetbc38b', 'SE-PreResNet-BC-38b', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnext50_32x4d', 'SE-ResNeXt-50 (32x4d)', '1709.01507', 224, 0.875,
     'pytorch, from [Cadene/pretrained...pytorch]'),
    ('seresnext101_32x4d', 'SE-ResNeXt-101 (32x4d)', '1709.01507', 224, 0.875,
     'pytorch, from [Cadene/pretrained...pytorch]'),
    ('senet16', 'SENet-16', '1709.01507', 224, 0.875, 'pytorch'),
    ('senet28', 'SENet-28', '1709.01507', 224, 0.875, 'pytorch'),
    ('senet154', 'SENet-154', '1709.01507', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('ibn_resnet50', 'IBN-ResNet-50', '1807.09441', 224, 0.875, 'pytorch,  from [XingangPan/IBN-Net]'),
    ('ibn_resnet101', 'IBN-ResNet-101', '1807.09441', 224, 0.875, 'pytorch,  from [XingangPan/IBN-Net]'),
    ('ibnb_resnet50', 'IBN(b)-ResNet-50', '1807.09441', 224, 0.875, 'pytorch,  from [XingangPan/IBN-Net]'),
    ('ibn_resnext101_32x4d', 'IBN-ResNeXt-101 (32x4d)', '1807.09441', 224, 0.875,
     'pytorch,  from [XingangPan/IBN-Net]'),
    ('ibn_densenet121', 'IBN-DenseNet-121', '1807.09441', 224, 0.875, 'pytorch,  from [XingangPan/IBN-Net]'),
    ('ibn_densenet169', 'IBN-DenseNet-169', '1807.09441', 224, 0.875, 'pytorch,  from [XingangPan/IBN-Net]'),
    ('airnet50_1x64d_r2', 'AirNet50-1x64d (r=2)', '', 224, 0.875, 'pytorch, from [soeaver/AirNet-PyTorch]'),
    ('airnet50_1x64d_r16', 'AirNet50-1x64d (r=16)', '', 224, 0.875, 'pytorch, from [soeaver/AirNet-PyTorch]'),
    ('airnext50_32x4d_r2', 'AirNeXt50-32x4d (r=2)', '', 224, 0.875, 'pytorch, from [soeaver/AirNet-PyTorch]'),
    ('bam_resnet50', 'BAM-ResNet-50', '1807.06514', 224, 0.875, 'pytorch, from [Jongchan/attention-module]'),
    ('cbam_resnet50', 'CBAM-ResNet-50', '1807.06521', 224, 0.875, 'pytorch, from [Jongchan/attention-module]'),
    ('pyramidnet101_a360', 'PyramidNet-101 (a=360)', '1610.02915', 224, 0.875,
     'pytorch, from [dyhan0920/Pyramid...PyTorch]'),
    ('diracnet18v2', 'DiracNetV2-18', '1706.00388', 224, 0.875, 'pytorch, from [szagoruyko/diracnets]'),
    ('diracnet34v2', 'DiracNetV2-34', '1706.00388', 224, 0.875, 'pytorch, from [szagoruyko/diracnets]'),
    ('densenet121', 'DenseNet-121', '1608.06993', 224, 0.875, 'pytorch'),
    ('densenet161', 'DenseNet-161', '1608.06993', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('densenet169', 'DenseNet-169', '1608.06993', 224, 0.875, 'pytorch'),
    ('densenet201', 'DenseNet-201', '1608.06993', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('condensenet74_c4_g4', 'CondenseNet-74 (C=G=4)', '1711.09224', 224, 0.875,
     'pytorch, from [ShichenLiu/CondenseNet]'),
    ('condensenet74_c8_g8', 'CondenseNet-74 (C=G=8)', '1711.09224', 224, 0.875,
     'pytorch, from [ShichenLiu/CondenseNet]'),
    ('peleenet', 'PeleeNet', '1804.06882', 224, 0.875, 'pytorch'),
    ('wrn50_2', 'WRN-50-2', '1605.07146', 224, 0.875, 'pytorch, from [szagoruyko/functional-zoo]'),
    ('drnc26', 'DRN-C-26', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnc42', 'DRN-C-42', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnc58', 'DRN-C-58', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnd22', 'DRN-D-22', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnd38', 'DRN-D-38', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnd54', 'DRN-D-54', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('drnd105', 'DRN-D-105', '1705.09914', 224, 0.875, 'pytorch, from [fyu/drn]'),
    ('dpn68', 'DPN-68', '1707.01629', 224, 0.875, 'pytorch'),
    ('dpn98', 'DPN-98', '1707.01629', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('dpn131', 'DPN-131', '1707.01629', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('darknet_tiny', 'DarkNet Tiny', '', 224, 0.875, 'pytorch'),
    ('darknet_ref', 'DarkNet Ref', '', 224, 0.875, 'pytorch'),
    ('darknet53', 'DarkNet-53', '1804.02767', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('irevnet301', 'i-RevNet-301', '1802.07088', 224, 0.875, 'pytorch, from [jhjacobsen/pytorch-i-revnet]'),
    ('bagnet9', 'BagNet-9', '', 224, 0.875, 'pytorch, from [wielandbrendel/bag...models]'),
    ('bagnet17', 'BagNet-17', '', 224, 0.875, 'pytorch, from [wielandbrendel/bag...models]'),
    ('bagnet33', 'BagNet-33', '', 224, 0.875, 'pytorch, from [wielandbrendel/bag...models]'),
    ('dla34', 'DLA-34', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla46c', 'DLA-46-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla46xc', 'DLA-X-46-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla60', 'DLA-60', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla60x', 'DLA-X-60', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla60xc', 'DLA-X-60-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla102', 'DLA-102', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla102x', 'DLA-X-102', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla102x2', 'DLA-X2-102', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('dla169', 'DLA-169', '1707.06484', 224, 0.875, 'pytorch, from [ucbdrive/dla]'),
    ('fishnet150', 'FishNet-150', '', 224, 0.875, 'pytorch, from [kevin-ssy/FishNet]'),
    ('espnetv2_wd2', 'ESPNetv2 x0.5', '1811.11431', 224, 0.875, 'pytorch, from [sacmehta/ESPNetv2]'),
    ('espnetv2_w1', 'ESPNetv2 x1.0', '1811.11431', 224, 0.875, 'pytorch, from [sacmehta/ESPNetv2]'),
    ('espnetv2_w5d4', 'ESPNetv2 x1.25', '1811.11431', 224, 0.875, 'pytorch, from [sacmehta/ESPNetv2]'),
    ('espnetv2_w3d2', 'ESPNetv2 x1.5', '1811.11431', 224, 0.875, 'pytorch, from [sacmehta/ESPNetv2]'),
    ('espnetv2_w2', 'ESPNetv2 x2.0', '1811.11431', 224, 0.875, 'pytorch, from [sacmehta/ESPNetv2]'),
    ('squeezenet_v1_0', 'SqueezeNet v1.0', '1602.07360', 224, 0.875, 'pytorch'),
    ('squeezenet_v1_1', 'SqueezeNet v1.1', '1602.07360', 224, 0.875, 'pytorch'),
    ('squeezeresnet_v1_0', 'SqueezeResNet v1.0', '1602.07360', 224, 0.875, 'pytorch'),
    ('squeezeresnet_v1_1', 'SqueezeResNet v1.1', '1602.07360', 224, 0.875, 'pytorch'),
    ('sqnxt23_w1', '1.0-SqNxt-23', '1803.10615', 224, 0.875, 'pytorch'),
    ('sqnxt23v5_w1', '1.0-SqNxt-23v5', '1803.10615', 224, 0.875, 'pytorch'),
    ('sqnxt23_w3d2', '1.5-SqNxt-23', '1803.10615', 224, 0.875, 'pytorch'),
    ('sqnxt23v5_w3d2', '1.5-SqNxt-23v5', '1803.10615', 224, 0.875, 'pytorch'),
    ('sqnxt23_w2', '2.0-SqNxt-23', '1803.10615', 224, 0.875, 'pytorch'),
    ('sqnxt23v5_w2', '2.0-SqNxt-23v5', '1803.10615', 224, 0.875, 'pytorch'),
    ('shufflenet_g1_wd4', 'ShuffleNet x0.25 (g=1)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g3_wd4', 'ShuffleNet x0.25 (g=3)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g1_wd2', 'ShuffleNet x0.5 (g=1)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g3_wd2', 'ShuffleNet x0.5 (g=3)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g1_w3d4', 'ShuffleNet x0.75 (g=1)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g3_w3d4', 'ShuffleNet x0.75 (g=3)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g1_w1', 'ShuffleNet x1.0 (g=1)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g2_w1', 'ShuffleNet x1.0 (g=2)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g3_w1', 'ShuffleNet x1.0 (g=3)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g4_w1', 'ShuffleNet x1.0 (g=4)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenet_g8_w1', 'ShuffleNet x1.0 (g=8)', '1707.01083', 224, 0.875, 'pytorch'),
    ('shufflenetv2_wd2', 'ShuffleNetV2 x0.5', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2_w1', 'ShuffleNetV2 x1.0', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2_w3d2', 'ShuffleNetV2 x1.5', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2_w2', 'ShuffleNetV2 x2.0', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2b_wd2', 'ShuffleNetV2b x0.5', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2b_w1', 'ShuffleNetV2b x1.0', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2b_w3d2', 'ShuffleNetV2b x1.5', '1807.11164', 224, 0.875, 'pytorch'),
    ('shufflenetv2b_w2', 'ShuffleNetV2b x2.0', '1807.11164', 224, 0.875, 'pytorch'),
    ('menet108_8x1_g3', '108-MENet-8x1 (g=3)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet128_8x1_g4', '128-MENet-8x1 (g=4)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet160_8x1_g8', '160-MENet-8x1 (g=8)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet228_12x1_g3', '228-MENet-12x1 (g=3)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet256_12x1_g4', '256-MENet-12x1 (g=4)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet348_12x1_g3', '348-MENet-12x1 (g=3)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet352_12x1_g8', '352-MENet-12x1 (g=8)', '1803.09127', 224, 0.875, 'pytorch'),
    ('menet456_24x1_g3', '456-MENet-24x1 (g=3)', '1803.09127', 224, 0.875, 'pytorch'),
    ('mobilenet_wd4', 'MobileNet x0.25', '1704.04861', 224, 0.875, 'pytorch'),
    ('mobilenet_wd2', 'MobileNet x0.5', '1704.04861', 224, 0.875, 'pytorch'),
    ('mobilenet_w3d4', 'MobileNet x0.75', '1704.04861', 224, 0.875, 'pytorch'),
    ('mobilenet_w1', 'MobileNet x1.0', '1704.04861', 224, 0.875, 'pytorch'),
    ('fdmobilenet_wd4', 'FD-MobileNet x0.25', '1802.03750', 224, 0.875, 'pytorch'),
    ('fdmobilenet_wd2', 'FD-MobileNet x0.5', '1802.03750', 224, 0.875, 'pytorch'),
    ('fdmobilenet_w3d4', 'FD-MobileNet x0.75', '1802.03750', 224, 0.875, 'pytorch'),
    ('fdmobilenet_w1', 'FD-MobileNet x1.0', '1802.03750', 224, 0.875, 'pytorch'),
    ('mobilenetv2_wd4', 'MobileNetV2 x0.25', '1801.04381', 224, 0.875, 'pytorch'),
    ('mobilenetv2_wd2', 'MobileNetV2 x0.5', '1801.04381', 224, 0.875, 'pytorch'),
    ('mobilenetv2_w3d4', 'MobileNetV2 x0.75', '1801.04381', 224, 0.875, 'pytorch'),
    ('mobilenetv2_w1', 'MobileNetV2 x1.0', '1801.04381', 224, 0.875, 'pytorch'),
    ('mobilenetv3_large_w1', 'MobileNetV3 L/224/1.0', '1905.02244', 224, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('igcv3_wd4', 'IGCV3 x0.25', '1806.00178', 224, 0.875, 'pytorch'),
    ('igcv3_wd2', 'IGCV3 x0.5', '1806.00178', 224, 0.875, 'pytorch'),
    ('igcv3_w3d4', 'IGCV3 x0.75', '1806.00178', 224, 0.875, 'pytorch'),
    ('igcv3_w1', 'IGCV3 x1.0', '1806.00178', 224, 0.875, 'pytorch'),
    ('mnasnet', 'MnasNet', '1807.11626', 224, 0.875, 'pytorch, from [zeusees/Mnasnet...Model]'),
    ('darts', 'DARTS', '1806.09055', 224, 0.875, 'pytorch, from [quark0/darts]'),
    ('proxylessnas_cpu', 'ProxylessNAS CPU', '1812.00332', 224, 0.875, 'pytorch, from [MIT-HAN-LAB/ProxylessNAS]'),
    ('proxylessnas_gpu', 'ProxylessNAS GPU', '1812.00332', 224, 0.875, 'pytorch'),
    ('proxylessnas_mobile', 'ProxylessNAS Mobile', '1812.00332', 224, 0.875,
     'pytorch, from [MIT-HAN-LAB/ProxylessNAS]'),
    ('proxylessnas_mobile14', 'ProxylessNAS Mob-14', '1812.00332', 224, 0.875, 'pytorch'),
    ('xception', 'Xception', '1610.02357', 299, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('inceptionv3', 'InceptionV3', '1512.00567', 299, 0.875, 'pytorch, from [dmlc/gluon-cv]'),
    ('inceptionv4', 'InceptionV4', '1602.07261', 299, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('inceptionresnetv2', 'InceptionResNetV', '1602.07261', 299, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('polynet', 'PolyNet', '1611.05725', 331, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('nasnet_4a1056', 'NASNet-A 4@1056', '1707.07012', 224, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('nasnet_6a4032', 'NASNet-A 6@4032', '1707.07012', 331, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('pnasnet5large', 'PNASNet-5-Large', '1712.00559', 331, 0.875, 'pytorch, from [Cadene/pretrained...pytorch]'),
    ('efficientnet_b0', 'EfficientNet-B0', '1905.11946', 224, 0.875, 'pytorch'),
    ('efficientnet_b1', 'EfficientNet-B1', '1905.11946', 240, 0.882, 'pytorch'),
    ('efficientnet_b0b', 'EfficientNet-B0b', '1905.11946', 224, 0.875, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b1b', 'EfficientNet-B1b', '1905.11946', 240, 0.882, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b2b', 'EfficientNet-B2b', '1905.11946', 260, 0.890, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b3b', 'EfficientNet-B3b', '1905.11946', 300, 0.904, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b4b', 'EfficientNet-B4b', '1905.11946', 380, 0.922, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b5b', 'EfficientNet-B5b', '1905.11946', 456, 0.934, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b6b', 'EfficientNet-B6b', '1905.11946', 528, 0.942, 'pytorch, from [rwightman/pyt...models]'),
    ('efficientnet_b7b', 'EfficientNet-B7b', '1905.11946', 600, 0.949, 'pytorch, from [rwightman/pyt...models]'),
    ('mixnet_s', 'MixNet-S', '1907.09595', 224, 0.875, 'pytorch, from [rwightman/pyt...models]'),
    ('mixnet_m', 'MixNet-M', '1907.09595', 224, 0.875, 'pytorch, from [rwightman/pyt...models]'),
)
