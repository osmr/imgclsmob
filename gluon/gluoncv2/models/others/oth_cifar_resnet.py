...
__all__ = ['oth_cifar_resnet20_v1', 'oth_cifar_resnet56_v1', 'oth_cifar_resnet110_v1',
           'oth_cifar_resnet20_v2', 'oth_cifar_resnet56_v2', 'oth_cifar_resnet110_v2']
...
# Constructor
def get_cifar_resnet(version, num_layers, in_channels=3, pretrained=False, ctx=cpu(),
...
def oth_cifar_resnet20_v1(**kwargs):
...
def oth_cifar_resnet56_v1(**kwargs):
...
def oth_cifar_resnet110_v1(**kwargs):
...
def oth_cifar_resnet20_v2(**kwargs):
...
def oth_cifar_resnet56_v2(**kwargs):
...
def oth_cifar_resnet110_v2(**kwargs):
