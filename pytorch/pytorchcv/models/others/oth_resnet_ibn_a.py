...
def _test():
    ...
    for model in models:
        ...
        assert (model != resnet50_ibn_a or weight_count == 25557032)
        assert (model != resnet101_ibn_a or weight_count == 44549160)
        assert (model != resnet152_ibn_a or weight_count == 60192808)
