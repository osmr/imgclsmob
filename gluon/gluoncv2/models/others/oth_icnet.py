...
__all__ = ['oth_icnet_resnet50_citys']
...
class ICNet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=False, ctx=cpu(), pretrained_base=True,
                 height=None, width=None, base_size=520, crop_size=480, lr_mult=10,
                 in_channels=3,
                 in_size=(256, 192),
                 **kwargs):
...
def _test():
    ...
    for model in models:
        ...
        assert (model != oth_icnet_resnet50_citys or weight_count == 47489184)
