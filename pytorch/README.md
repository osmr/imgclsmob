...
| ResNet-152 | 20.26 | 5.16 | 60,192,808 | 11,321.85M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.506/resnet152-0516-84a0f8e8.pth.log)) |
