...
trained_model_metainfo_list = (
    ...
    ('vgg19', 'VGG-19', '1409.1556', 224, 0.875, 'pytorch'),
    ...
    ('bn_vgg13b', 'BN-VGG-13b', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg16b', 'BN-VGG-16b', '1409.1556', 224, 0.875, 'pytorch'),
    ('bn_vgg19b', 'BN-VGG-19b', '1409.1556', 224, 0.875, 'pytorch'),
    ...
    ('resnet101', 'ResNet-101', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet101b', 'ResNet-101b', '1512.03385', 224, 0.875, 'pytorch'),
    ('resnet152', 'ResNet-152', '1512.03385', 224, 0.875, 'pytorch'),
    ...
    ('preresnet101', 'PreResNet-101', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet101b', 'PreResNet-101b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet152', 'PreResNet-152', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet152b', 'PreResNet-152b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet200b', 'PreResNet-200b', '1603.05027', 224, 0.875, 'pytorch'),
    ('preresnet269b', 'PreResNet-269b', '1603.05027', 224, 0.875, 'pytorch'),
    ...
    ('resnext101_32x4d', 'ResNeXt-101 (32x4d)', '1611.05431', 224, 0.875, 'pytorch'),
    ('resnext101_64x4d', 'ResNeXt-101 (64x4d)', '1611.05431', 224, 0.875, 'pytorch'),
    ...
    ('seresnet50', 'SE-ResNet-50', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet50b', 'SE-ResNet-50b', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet101', 'SE-ResNet-101', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnet152', 'SE-ResNet-152', '1709.01507', 224, 0.875, 'pytorch'),
    ...
    ('seresnext50_32x4d', 'SE-ResNeXt-50 (32x4d)', '1709.01507', 224, 0.875, 'pytorch'),
    ('seresnext101_32x4d', 'SE-ResNeXt-101 (32x4d)', '1709.01507', 224, 0.875, 'pytorch'),
    ('senet16', 'SENet-16', '1709.01507', 224, 0.875, 'pytorch'),
    ('senet28', 'SENet-28', '1709.01507', 224, 0.875, 'pytorch'),
    ('senet154', 'SENet-154', '1709.01507', 224, 0.875, 'pytorch'),
    ('ibn_resnet50', 'IBN-ResNet-50', '1807.09441', 224, 0.875, 'pytorch'),
    ('ibn_resnet101', 'IBN-ResNet-101', '1807.09441', 224, 0.875, 'pytorch'),
    ('ibnb_resnet50', 'IBN(b)-ResNet-50', '1807.09441', 224, 0.875, 'pytorch'),
    ('ibn_resnext101_32x4d', 'IBN-ResNeXt-101 (32x4d)', '1807.09441', 224, 0.875, 'pytorch'),
    ('ibn_densenet121', 'IBN-DenseNet-121', '1807.09441', 224, 0.875, 'pytorch'),
    ('ibn_densenet169', 'IBN-DenseNet-169', '1807.09441', 224, 0.875, 'pytorch'),
    ('airnet50_1x64d_r2', 'AirNet50-1x64d (r=2)', '', 224, 0.875, 'pytorch'),
    ('airnet50_1x64d_r16', 'AirNet50-1x64d (r=16)', '', 224, 0.875, 'pytorch'),
    ('airnext50_32x4d_r2', 'AirNeXt50-32x4d (r=2)', '', 224, 0.875, 'pytorch'),
    ('bam_resnet50', 'BAM-ResNet-50', '1807.06514', 224, 0.875, 'pytorch'),
    ('cbam_resnet50', 'CBAM-ResNet-50', '1807.06521', 224, 0.875, 'pytorch'),
    ('pyramidnet101_a360', 'PyramidNet-101 (a=360)', '1610.02915', 224, 0.875, 'pytorch'),
    ('diracnet18v2', 'DiracNetV2-18', '1706.00388', 224, 0.875, 'pytorch'),
    ('diracnet34v2', 'DiracNetV2-34', '1706.00388', 224, 0.875, 'pytorch'),
    ('densenet121', 'DenseNet-121', '1608.06993', 224, 0.875, 'pytorch'),
    ('densenet161', 'DenseNet-161', '1608.06993', 224, 0.875, 'pytorch'),
    ('densenet169', 'DenseNet-169', '1608.06993', 224, 0.875, 'pytorch'),
    ('densenet201', 'DenseNet-201', '1608.06993', 224, 0.875, 'pytorch'),
    ('condensenet74_c4_g4', 'CondenseNet-74 (C=G=4)', '1711.09224', 224, 0.875, 'pytorch'),
    ('condensenet74_c8_g8', 'CondenseNet-74 (C=G=8)', '1711.09224', 224, 0.875, 'pytorch'),
    ('peleenet', 'PeleeNet', '1804.06882', 224, 0.875, 'pytorch'),
    ('wrn50_2', 'WRN-50-2', '1605.07146', 224, 0.875, 'pytorch'),
    ('drnc26', 'DRN-C-26', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnc42', 'DRN-C-42', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnc58', 'DRN-C-58', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnd22', 'DRN-D-22', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnd38', 'DRN-D-38', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnd54', 'DRN-D-54', '1705.09914', 224, 0.875, 'pytorch'),
    ('drnd105', 'DRN-D-105', '1705.09914', 224, 0.875, 'pytorch'),
    ('dpn68', 'DPN-68', '1707.01629', 224, 0.875, 'pytorch'),
    ('dpn98', 'DPN-98', '1707.01629', 224, 0.875, 'pytorch'),
    ('dpn131', 'DPN-131', '1707.01629', 224, 0.875, 'pytorch'),
    ('darknet_tiny', 'DarkNet Tiny', '', 224, 0.875, 'pytorch'),
    ('darknet_ref', 'DarkNet Ref', '', 224, 0.875, 'pytorch'),
    ('darknet53', 'DarkNet-53', '1804.02767', 224, 0.875, 'pytorch'),
    ('irevnet301', 'i-RevNet-301', '1802.07088', 224, 0.875, 'pytorch'),
    ('bagnet9', 'BagNet-9', '', 224, 0.875, 'pytorch'),
    ('bagnet17', 'BagNet-17', '', 224, 0.875, 'pytorch'),
    ('bagnet33', 'BagNet-33', '', 224, 0.875, 'pytorch'),
    ('dla34', 'DLA-34', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla46c', 'DLA-46-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla46xc', 'DLA-X-46-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla60', 'DLA-60', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla60x', 'DLA-X-60', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla60xc', 'DLA-X-60-C', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla102', 'DLA-102', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla102x', 'DLA-X-102', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla102x2', 'DLA-X2-102', '1707.06484', 224, 0.875, 'pytorch'),
    ('dla169', 'DLA-169', '1707.06484', 224, 0.875, 'pytorch'),
    ('fishnet150', 'FishNet-150', '', 224, 0.875, 'pytorch'),
    ('espnetv2_wd2', 'ESPNetv2 x0.5', '1811.11431', 224, 0.875, 'pytorch'),
    ('espnetv2_w1', 'ESPNetv2 x1.0', '1811.11431', 224, 0.875, 'pytorch'),
    ('espnetv2_w5d4', 'ESPNetv2 x1.25', '1811.11431', 224, 0.875, 'pytorch'),
    ('espnetv2_w3d2', 'ESPNetv2 x1.5', '1811.11431', 224, 0.875, 'pytorch'),
    ('espnetv2_w2', 'ESPNetv2 x2.0', '1811.11431', 224, 0.875, 'pytorch'),
    ...
    ('mobilenetv3_large_w1', 'MobileNetV3 L/224/1.0', '1905.02244', 224, 0.875, 'pytorch'),
    ...
    ('mnasnet', 'MnasNet', '1807.11626', 224, 0.875, 'pytorch'),
    ('darts', 'DARTS', '1806.09055', 224, 0.875, 'pytorch'),
    ('proxylessnas_cpu', 'ProxylessNAS CPU', '1812.00332', 224, 0.875, 'pytorch'),
    ('proxylessnas_gpu', 'ProxylessNAS GPU', '1812.00332', 224, 0.875, 'pytorch'),
    ('proxylessnas_mobile', 'ProxylessNAS Mobile', '1812.00332', 224, 0.875, 'pytorch'),
    ('proxylessnas_mobile14', 'ProxylessNAS Mob-14', '1812.00332', 224, 0.875, 'pytorch'),
    # ('xception', 'Xception', '1610.02357', 224, 0.875, 'pytorch'),
    # ('inceptionv3', 'InceptionV3', '1512.00567', 224, 0.875, 'pytorch'),
    # ('inceptionv4', 'InceptionV4', '1602.07261', 224, 0.875, 'pytorch'),
    # ('inceptionresnetv2', 'InceptionResNetV', '1602.07261', 224, 0.875, 'pytorch'),
    # ('polynet', 'PolyNet', '1611.05725', 224, 0.875, 'pytorch'),
    # ('nasnet_4a1056', 'NASNet-A 4@1056', '1707.07012', 224, 0.875, 'pytorch'),
    # ('nasnet_6a4032', 'NASNet-A 6@4032', '1707.07012', 224, 0.875, 'pytorch'),
    # ('pnasnet5large', 'PNASNet-5-Large', '1712.00559', 224, 0.875, 'pytorch'),
    # ('efficientnet_b0', 'EfficientNet-B0', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b1', 'EfficientNet-B1', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b0b', 'EfficientNet-B0b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b1b', 'EfficientNet-B1b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b2b', 'EfficientNet-B2b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b3b', 'EfficientNet-B3b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b4b', 'EfficientNet-B4b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b5b', 'EfficientNet-B5b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b6b', 'EfficientNet-B6b', '1905.11946', 224, 0.875, 'pytorch'),
    # ('efficientnet_b7b', 'EfficientNet-B7b', '1905.11946', 224, 0.875, 'pytorch'),
    ('mixnet_s', 'MixNet-S', '1907.09595', 224, 0.875, 'pytorch'),
    ('mixnet_m', 'MixNet-M', '1907.09595', 224, 0.875, 'pytorch'),
)
