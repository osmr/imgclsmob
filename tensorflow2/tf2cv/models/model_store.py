...
_model_sha1 = {name: (error, checksum, repo_release_tag, ds, scale) for
    ...
    ('resnet10', '1226', 'f91c99958e6093db8db8b380a3abf4fa011471fd', 'v0.0.569', 'in1k', 0.875),
    ...
    ('preresnet200b', '0448', '94152aa3e45bb3c923d3d09199dcde475058bbfe', 'v0.0.529', 'in1k', 0.875),
    ('preresnet269b', '0505', '035c04e12978735f564638e20d5394c034d44252', 'v0.0.545', 'in1k', 0.875),
    ...
    ('resnext101_32x4d', '0418', '65226e18c3e2d54f8d82a891ffac1e29dea7ba9f', 'v0.0.530', 'in1k', 0.875),
    ...
    ('seresnet12', '1177', 'a05bd730dbfff6c939ce0f1c277059f247b1b1e4', 'v0.0.544', 'in1k', 0.875),
    ('seresnet14', '1101', 'c695031bf44e1a3387ac688f4e159b5d35de880f', 'v0.0.545', 'in1k', 0.875),
    ('seresnet16', '0971', '75ab24870f099f62fafc669cde719535be5e8585', 'v0.0.545', 'in1k', 0.875),
    ...
    ('seresnet101', '0440', '8d2f638235dc0f72bec4aff216e4e247f2264751', 'v0.0.533', 'in1k', 0.875),
    ('seresnet101b', '0464', 'a10be1d25d3112825e7b77277d6c56eb276dc799', 'v0.0.460', 'in1k', 0.875),
    ('seresnet152', '0429', '3fedbd3340f8610a4b4ae8e41a578a5c8588da8c', 'v0.0.538', 'in1k', 0.875),
    ('sepreresnet10', '1221', 'f0634079aac13e67afcac504709ff2ab33e08839', 'v0.0.544', 'in1k', 0.875),
    ('sepreresnet12', '1182', '9d52ac4f6fed4d819e03060e931e3b8365b7776b', 'v0.0.543', 'in1k', 0.875),
    ('sepreresnet16', '0956', '67583059c98b5114166b5101cea3850e5b996ef4', 'v0.0.543', 'in1k', 0.875),
    ('sepreresnet18', '0882', '9f039d7e462942253844a0d20bfb0ac4c95749ff', 'v0.0.543', 'in1k', 0.875),
    ('sepreresnet26', '0805', '042a83165dc8861ebf13a19f7ac387f21af23e7b', 'v0.0.543', 'in1k', 0.875),
    ...
    ('seresnext101_32x4d', '0446', 'e2f5ca884c866a7833b8bce2b1240a280e2caf4e', 'v0.0.529', 'in1k', 0.875),
    ('seresnext101_64x4d', '0407', 'd34b057ec428551d7c8fc666587ecf79d1b8eb62', 'v0.0.561', 'in1k', 0.875),
    ...
    ('senet154', '0440', '69802af4dcb9036514c8ca80aad01fda7b66f7ee', 'v0.0.522', 'in1k', 0.875),
    ...
    ('resnesta50', '0439', '9ef477b8d0abd63be449baf1c2f6a3e29d78c56d', 'v0.0.531', 'in1k', 0.875),
    ('resnesta101', '0400', 'bb2a90f59e103c73bdfc75fc8b8d898325444069', 'v0.0.465', 'in1k', 0.875),
    ('resnesta152', '0450', 'b21a24bf84ed63cd43a36f880ddefec74dde13e9', 'v0.0.540', 'in1k', 0.875),
    ...
    ('ibn_resnet101', '0489', '325dbc1ccc5fa2ac608bf8d146543fd1957c7d93', 'v0.0.552', 'in1k', 0.875),
    ('ibnb_resnet50', '0580', 'dbf9219a38cfa3a43b2cbb23efe4bb53f5f383be', 'v0.0.552', 'in1k', 0.875),
    ('ibn_resnext101_32x4d', '0490', '5e262e0dd5f7264a9f8047e070da21099f59e24d', 'v0.0.553', 'in1k', 0.875),
    ...
    ('airnet50_1x64d_r2', '0528', '065bd85bd79e7b4fe58a284dffc00eec79672554', 'v0.0.522', 'in1k', 0.875),
    ('airnet50_1x64d_r16', '0550', '9500236cd5cce3d991b6d435a1950d23dab7a285', 'v0.0.519', 'in1k', 0.875),
    ('airnext50_32x4d_r2', '0514', '51089a6b08a25a0c9224a67320980245a6be30b6', 'v0.0.521', 'in1k', 0.875),
    ('bam_resnet50', '0537', 'a9720e151405bd9d1bf361fbcb817e431314904f', 'v0.0.499', 'in1k', 0.875),
    ('cbam_resnet50', '0486', 'f4495a7942b578bfeb4f2a4a221827e37124b094', 'v0.0.537', 'in1k', 0.875),
    ...
    ('regnetx064', '0457', 'fbb602bcc1842d26d550d4ec3dd222e05b548638', 'v0.0.535', 'in1k', 0.875),
    ('regnetx080', '0466', 'c101c5242bbd7cf52958c2f5f81fca09a4d21091', 'v0.0.515', 'in1k', 0.875),
    ('regnetx120', '0521', '7eb9799acf3949832867ba67e520662b54af66ff', 'v0.0.542', 'in1k', 0.875),
    ('regnetx160', '0458', '428d1dc3450a91fe261288386c0e07a5b491e33b', 'v0.0.532', 'in1k', 0.875),
    ('regnetx320', '0395', 'b7354725c1de9736f1d69d11c9f8b47e2d19314a', 'v0.0.548', 'in1k', 0.875),
    ...
    ('regnety120', '0429', '1d6a27ba993b9c0f885fc8ff8569f9fa8dd2488b', 'v0.0.526', 'in1k', 0.875),
    ('regnety160', '0429', '5a9e11914a6b299ac404a2b4bbccdff32af6b9f1', 'v0.0.527', 'in1k', 0.875),
    ('regnety320', '0373', 'e5ac157ceace9b464e38def00ea8695a8f514e5b', 'v0.0.550', 'in1k', 0.875),
    ...
    ('wrn50_2', '0608', '646ef77ea91cc2105cfd55e9587f2a2d29f10e98', 'v0.0.520', 'in1k', 0.875),
    ('drnc26', '0710', '4797ca29cd710769b8361879e47c14dec3a4718c', 'v0.0.508', 'in1k', 0.875),
    ('drnc42', '0612', 'afd99699ae54a6ad13d09869fbe97d569725174d', 'v0.0.556', 'in1k', 0.875),
    ('drnc58', '0517', '2e3cae869e6fa62c9895a94d78484421a2b0c58d', 'v0.0.559', 'in1k', 0.875),
    ...
    ('bagnet33', '1041', '29b0a0634dec61d81619f63630f3e9bb45e8e13e', 'v0.0.561', 'in1k', 0.875),
    ...
    ('dla102x', '0474', 'dfef2c8122a48cdd24acbc5f41720f30edb9893c', 'v0.0.528', 'in1k', 0.875),
    ('dla102x2', '0428', 'e05fb468d1af87887e1b5a3b27f4429577497b8f', 'v0.0.542', 'in1k', 0.875),
    ...
    ('dicenet_w7d8', '1131', '008459595b70042884480f4946fee807384e781e', 'v0.0.527', 'in1k', 0.875),
    ('dicenet_w2', '0955', '6301dc901a2e92f0591eed98d14a1b5d1df6de39', 'v0.0.569', 'in1k', 0.875),
    ...
    ('hrnetv2_w30', '0508', 'f498640226679bee7792f50a6da403cd3836ba44', 'v0.0.525', 'in1k', 0.875),
    ('hrnetv2_w32', '0495', 'ab96120c9db009f0b7c8bb9310ac67b3113e7502', 'v0.0.528', 'in1k', 0.875),
    ('hrnetv2_w40', '0480', '783aff21a18a035362527464b47b72277ceb6ed1', 'v0.0.534', 'in1k', 0.875),
    ('hrnetv2_w44', '0488', '14fcc1a2c49eb808782f808b84a125629a677e29', 'v0.0.541', 'in1k', 0.875),
    ('hrnetv2_w48', '0481', '7b8bb74f095831ebc2c71f2bf9c765800ed36df5', 'v0.0.541', 'in1k', 0.875),
    ('hrnetv2_w64', '0479', '0bd946ed4729dc338f6299e403f348bcfda2ea8a', 'v0.0.543', 'in1k', 0.875),
    ('vovnet27s', '1154', 'f36b2e780f19e2e6638d723a6572c887118feffb', 'v0.0.551', 'in1k', 0.875),
    ...
    ('hardnet68', '0704', 'c968512e936a77c8fd40e2743e46fbe74318d944', 'v0.0.557', 'in1k', 0.875),
    ...
    ('inceptionv3', '0536', '7a70b62fef648deadbca8a10974b4ff3faa06092', 'v0.0.552', 'in1k', 0.875),
    ('inceptionv4', '0506', '62135f80437e8d069ec6656545ccd1df2490d81c', 'v0.0.543', 'in1k', 0.875),
    ('inceptionresnetv1', '0480', 'e2968df03fbb249e8dc32c48667c92b26ded27fb', 'v0.0.552', 'in1k', 0.875),
    ...
    ('resneta101b', '0445', '1e0df949ecb3b65ab545ffaf14be8e550bdd37ab', 'v0.0.532', 'in1k', 0.875),
    ('resneta152b', '0426', '2e42f2ac3a3e3759866c89f8f9ccf1426f000be0', 'v0.0.524', 'in1k', 0.875),
