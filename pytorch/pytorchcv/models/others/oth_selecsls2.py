...
class SelecSLS(nn.Module):
    ...
    """
    def __init__(self, cfg, num_classes=1000, in_chans=3):
...
def oth_selecsls42(pretrained=False, **kwargs):
    return _create_model('selecsls42', pretrained=pretrained, model_kwargs=kwargs)
...
def oth_selecsls84(pretrained=False, **kwargs):
    return _create_model('selecsls84', pretrained=pretrained, model_kwargs=kwargs)
...
def _test():
    ...
    for model in models:
        ...
        assert (model != oth_selecsls42 or weight_count == 30354952)
        ...
        assert (model != oth_selecsls84 or weight_count == 50954600)
