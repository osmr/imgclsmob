...
| PreResNet-200b | 19.77 | 5.10 | 64,666,280 | 15,068.63M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.524/preresnet200b-0510-9f0e7f01.pth.log)) |
...
| SE-ResNet-101 | 19.77 | 4.92 | 49,326,872 | 7,602.76M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.508/seresnet101-0492-21336620.pth.log)) |
...
| SE-ResNeXt-101 (32x4d) | 19.67 | 4.76 | 48,955,416 | 8,012.73M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.525/seresnext101_32x4d-0476-2a3b9d3b.pth.log)) |
...
| CBAM-ResNet-50 | 20.59 | 5.24 | 28,089,624 | 4,116.97M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.514/cbam_resnet50-0524-f824c591.pth.log)) |
...
| RegNetY-12GF | 19.07 | 4.61 | 51,822,544 | 12,132.55M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.524/regnety120-0461-6ce18cad.pth.log)) |
| RegNetY-16GF | 20.25 | 4.98 | 83,590,140 | 15,944.53M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.525/regnety160-0498-66977a86.pth.log)) |
...
| ResNet(A)-101b | 19.78 | 5.07 | 44,568,392 | 8,072.93M | Converted from GL model ([log](https://github.com/osmr/imgclsmob/releases/download/v0.0.511/resneta101b-0507-962c37d5.pth.log)) |
