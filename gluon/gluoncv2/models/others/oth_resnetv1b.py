...
__all__ = ['oth_resnet18_v1b', 'oth_resnet34_v1b',
           'oth_resnet50_v1b', 'oth_resnet101_v1b',
           'oth_resnet152_v1b']
...
class ResNetV1b(HybridBlock):
    ...
    def __init__(self, block, layers, classes=1000, dilated=False, norm_layer=BatchNorm,
                 ...
                 name_prefix='', in_channels=3, **kwargs):
...
def oth_resnet18_v1b(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def oth_resnet34_v1b(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def oth_resnet50_v1b(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def oth_resnet101_v1b(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def oth_resnet152_v1b(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
