...
# from tensorpack import Conv2D, BatchNorm, MaxPooling, LinearWrap, TrainConfig, SyncMultiGPUTrainerReplicated,\
#     ClassificationError, ModelSaver, GPUUtilizationTracker, EstimatedTimeLeft, ScheduledHyperParamSetter,\
#     DataParallelInferenceRunner, QueueInput, StagingInput, launch_train_with_config, logger
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch', type=int, default=256, help='batch per GPU')
