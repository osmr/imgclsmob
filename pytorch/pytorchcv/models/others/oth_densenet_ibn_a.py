...
def _test():
    ...
    for model in models:
        ...
        assert (model != densenet121_ibn_a or weight_count == 7978856)
        assert (model != densenet161_ibn_a or weight_count == 28681000)
        assert (model != densenet169_ibn_a or weight_count == 14149480)
        assert (model != densenet201_ibn_a or weight_count == 20013928)
