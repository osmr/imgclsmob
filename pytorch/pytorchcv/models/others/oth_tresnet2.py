...
from timm.models.layers import SpaceToDepthModule, AntiAliasDownsampleLayer, ClassifierHead, SEModule
...
def conv2d_iabn(ni, nf, stride, kernel_size=3, groups=1, act_layer="leaky_relu", act_param=1e-2):
    return nn.Sequential(
        ...
        nn.LeakyReLU(negative_slope=act_param, inplace=True)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.stride = stride
        assert (planes * self.expansion // 4 <= 64)
